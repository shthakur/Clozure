...
<div class="shell">
  <!-- Header -->
  <div id="header">
    <h1 id="logo"><a href="#">clozure.com</a></h1>
    <!-- Cart -->
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div id="slider" class="box">
        <div id="slider-holder">
          <ul>
            ...
            <li><a href="#"><img src="css/images/2.png" alt="" /></a></li>
      ...
      <div class="products">
        <div class="cl">&nbsp;</div>
        <ul>
          <li> <a href="#"><img src="css/images/8.jpg" alt="" /></a>
          ...
          <li> <a href="#"><img src="css/images/7.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOREM IPSUM</h3>
              <div class="product-desc">
                <h4>WOMEN’S</h4>
           ...
           <li> <a href="#"><img src="css/images/5.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOREM IPSUM</h3>
              <div class="product-desc">
                <h4>WOMEN’S</h4>
          ...
          <li> <a href="#"><img src="css/images/6.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOREM IPSUM</h3>
              <div class="product-desc">
                <h4>WOMEN’S</h4>
